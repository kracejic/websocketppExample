...
* mainProjectFolder
    ...
    - **packaging**
        ...
        + websocketserver.desktop - linux shortcut (app is then visible in launchers)
        + websocketserver.png - icon for linux shortcut
        + websocketserver.icon.in.rc - icon for windows description file (used in source/CMakeLists.txt)
        + websocketserver.ico - icon for windows shortcut (linked via websocketserver.icon.in.rc into the executable)
